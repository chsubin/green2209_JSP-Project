...
<div class="container" style="margin-top:30px;">
    ...
    <input type="hidden" name="roomName" value="${vo.roomName}"/>
    <input type="hidden" name="rvIdx" value="${vo.rvIdx}"/>
    <input type="hidden" name="roomIdx" value="${vo.roomIdx}"/>
    <input type="hidden" name="checkIn" value="${vo.checkIn}"/>
    <input type="hidden" name="checkOut" value="${vo.checkOut}"/>
